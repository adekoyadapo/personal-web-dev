...
--------------------------------------------*/
    ...
    if (animation) {
      ...
      var text = $('#home .typer-title'),
          textOne = "IT Infrastructure and Devops Enthusiast",
          textTwo = "Constantly improving my skills in IT infrastructure, cloud and Devops",
          textThree = "Knowledge of Networks, Sysadmin, Virtualization and Cloud ",
          textFour = "Striving towards excellence in delivering quality service",
          textFive = "Learning and developing new skills for better collaboration",
          textSix = "Connect with me, click on any social platform below"

          if (!!$.prototype.typer) {
            text.typer([textOne,textTwo,textThree,textFour,textFive,textSix]);
          }
    }
